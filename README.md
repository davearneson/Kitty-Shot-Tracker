...
<p><img src="https://i.imgur.com/sPRQuOf.jpg" alt="Kitty Shot Given Notification"></p>
<pre><code># automations.yaml
...
<h4 id="if-one-of-us-gives-the-shot-the-other-is-notified.">If one of us gives the shot, the other is notified.</h4>
<p><img src="https://i.imgur.com/Nw3YdX5.jpg" alt="Kitty Shot Given Notification"></p>
<h4 id="actionable-notification-if-button-is-pushed-with-option-to-mark-who-gave-the-shot.">Actionable Notification if button is pushed, with option to mark who gave the shot.</h4>
<p><img src="https://i.imgur.com/y7sqRrc.jpg" alt="Kitty Shot Given Notification"></p>
<pre><code># automations.yaml
