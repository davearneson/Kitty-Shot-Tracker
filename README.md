...
![Kitty Shot Given Notification](https://i.imgur.com/sPRQuOf.jpg)
```
# automations.yaml
...
#### If one of us gives the shot, the other is notified.
![Kitty Shot Given Notification](https://i.imgur.com/Nw3YdX5.jpg)

#### Actionable Notification if button is pushed, with option to mark who gave the shot.
![Kitty Shot Given Notification](https://i.imgur.com/y7sqRrc.jpg)
